...
if (isset($_POST['submit'])) {
    ...
    if (!isset($error)) {
        ...
        $sql = "INSERT INTO vila (nama, lokasi, harga, deskripsi, kontak, email, kategori, maps_embed, id_admin) 
                VALUES ('$nama', '$lokasi', '$harga', '$deskripsi', '$kontak', '$email', '$kategori', '$maps_embed', '$id_admin')";
